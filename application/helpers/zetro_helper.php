	...
	function img_aksi($id='',$del=false,$only=''){
		$data='';
		 if($del==false && $only==''){ 
		   ...
		   $data="<img src='".base_url()."asset/images/no.png' id='simpan' onclick=\"images_click('".$id."','del');\" style='cursor:pointer' class='hapus' title='Click to delete'>";
		   ...
		   $data="<img src='".base_url()."asset/images/editor.png' id='simpan' onclick=\"images_click('".$id."','edit');\" style='cursor:pointer' class='simpan' title='Click to Edit '>
			...
			$data="<img src='".base_url()."asset/img/cog.png' id='proses' onclick=\"images_click('".$id."','pros');\" style='cursor:pointer' class='prosess' title='Click to prosess all '>
