...
if($c_penjualan__index!=''){
	...
	echo tr().
		 ...
		 td("<input type='text' id='".$i."__nm_barang' class='w100' name='".$i."__nm_barang' data-provide='typeahead' data-source=\"[".$datas."]\"value=''/>").
		 td("<input type='text' id='".$i."__nm_satuan' class='w100' name='".$i."__nm_satuan' value=''/>").
